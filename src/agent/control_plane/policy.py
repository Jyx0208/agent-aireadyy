...
TOOL_RISKS: dict[str, ToolRisk] = {
    ...
    "inspect_project_sdrf": "read_only",
    "submit_project_judgments": "bounded_write",
    "get_file_review_batch": "read_only",
    "submit_file_judgments": "bounded_write",
    "freeze_file_selection": "bounded_write",
    "get_discovery_state": "read_only",
    "audit_discovery_state": "read_only",
